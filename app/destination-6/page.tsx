							...
							<div className="row align-items-center">
								...
								<div className="col-lg-5">
									<div className="box-image-payment-2">
										<div className="row align-items-center">
											<div className="col-4 mb-30"><img className="bdrd8 w-100" src="/assets/imgs/page/destination/paris.png" alt="Travila" /></div>
											<div className="col-4 mb-30"><img className="bdrd8 w-100 mb-15" src="/assets/imgs/page/destination/paris2.png" alt="Travila" /><img className="bdrd8 w-100" src="/assets/imgs/page/destination/paris3.png" alt="Travila" /></div>
											<div className="col-4 mb-30"><img className="bdrd8 w-100 mb-15" src="/assets/imgs/page/destination/paris4.png" alt="Travila" /><img className="bdrd8 w-100" src="/assets/imgs/page/destination/paris5.png" alt="Travila" /></div>
										</div>
									</div>
								</div>
							</div>
